package com.xbzn.Intercom.socket;
...
import com.xbzn.Intercom.manager.RecordLogManager;
import com.xbzn.Intercom.mvp.model.entity.BaseConfig;
import com.xbzn.Intercom.mvp.model.entity.Group;
import com.xbzn.Intercom.mvp.model.entity.SingleBaseConfig;
import com.xbzn.Intercom.mvp.model.entity.User;
import com.xbzn.Intercom.socket.socketmodel.request.CleanLog;
import com.xbzn.Intercom.socket.socketmodel.request.DeleteRecords;
import com.xbzn.Intercom.socket.socketmodel.request.GetGroupList;
import com.xbzn.Intercom.socket.socketmodel.request.GetRecords;
import com.xbzn.Intercom.socket.socketmodel.request.GetUserInfo;
import com.xbzn.Intercom.socket.socketmodel.request.GetUserList;
import com.xbzn.Intercom.socket.socketmodel.request.GroupAdd;
import com.xbzn.Intercom.socket.socketmodel.request.GroupDelete;
import com.xbzn.Intercom.socket.socketmodel.request.RecordList;
import com.xbzn.Intercom.socket.socketmodel.request.UserAdd;
import com.xbzn.Intercom.socket.socketmodel.request.UserCopy;
import com.xbzn.Intercom.socket.socketmodel.request.UserDelete;
import com.xbzn.Intercom.socket.socketmodel.request.UserUpdate;
import com.xbzn.Intercom.socket.socketmodel.response.ResponeseUnKonwError;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseAddAndUpdate;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseCleanLog;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseDeleteRecords;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseDevice;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseGetGroupList;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseGetRecords;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseGetUserInfo;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseGetUserList;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseGroupAdd;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseGroupDelete;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseResetConfigFile;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseUserCopy;
import com.xbzn.Intercom.socket.socketmodel.response.ResponseUserDelete;
    ...
    public void choiceMessage(String messsage) {
        ...
        try {
            ...
            if (code == RequestConfig.resetConfigFile) {
                ...
                SingleBaseConfig.copyInstance((com.xbzn.Intercom.mvp.model.entity.BaseConfig) socketResult.getData());
                try {
