...
public class FaceApi {
     ...
     */
    public List<User> getUserCounttByUserName(String groupId, String userName) {
        if (TextUtils.isEmpty(groupId) || TextUtils.isEmpty(userName)) {
            return null;
        }
        List<User> userList = DBManager.getInstance().queryUserCountByUserName(groupId, userName);
        return userList;
    }
