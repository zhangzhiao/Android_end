package com.xbzn.Intercom.manager;
...
import static com.xbzn.Intercom.mvp.model.entity.GlobalSet.FEATURE_SIZE;
import static com.xbzn.Intercom.mvp.model.entity.GlobalSet.TIME_TAG;
    ...
    public void onDetectCheck(final byte[] rgbData,
        ...
        future = es.submit(new Runnable() {
            ...
            public void run() {
                ...
                // TODO: getImage() 获取送检图片,如果检测数据有问题，可以通过image com.xbzn.Intercom.view 展示送检图片
