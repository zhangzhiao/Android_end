package com.xbzn.Intercom.camera;
    ...
    private void openCamera() {
        ...
        try {
            if (mCamera == null) {
                ...
                Log.e(TAG, "initCamera---open camera"+mCamera);
            }
...
//                    cameraRotation = getCameraDisplayOrientation(cameraRotation, cameraId);
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, e.getMessage()+"摄像头？？？？？？？");
            }
        } catch (RuntimeException e) {
            Log.e(TAG, e.getMessage()+"摄像头？？？");
            //摄像头离线
            NetWorkStart netWorkStart =new NetWorkStart(null);
            netWorkStart.sendWarn_logs(new WarnInfoBean("","离线", TimeUtil.getTime(),"摄像头"));
